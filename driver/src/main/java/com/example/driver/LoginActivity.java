    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Util.signIn(email, password, new DriverCallback() {
                    @Override
                    public void onDriverReceived(Driver driver) {
                        progressBar.setVisibility(View.INVISIBLE);
                        UserPreferences.setUser(driver);
                    ...
                    @Override
                    public void onDriverNotFound(String error) {
                        progressBar.setVisibility(View.INVISIBLE);
