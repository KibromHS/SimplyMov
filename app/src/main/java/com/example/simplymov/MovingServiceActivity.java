...
public class MovingServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edTime.setOnClickListener(view -> {
            DatePickerDialog datePickerDialog = new DatePickerDialog(MovingServiceActivity.this, (view1, year, monthOfYear, dayOfMonth) -> {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(MovingServiceActivity.this, (view11, hourOfDay, minute) -> {
        ...
        bookBtn.setOnClickListener(view -> {
            if (checkedTruckSize == null) {
                Toast.makeText(MovingServiceActivity.this, "Please select truck size", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            LatLng pickup = MapUtil.geocodeAddress(MovingServiceActivity.this, from);
            if (pickup == null) {
                Toast.makeText(MovingServiceActivity.this, "Modify the pickup location", Toast.LENGTH_LONG).show();
                return;
            }
            LatLng dropOff = MapUtil.geocodeAddress(MovingServiceActivity.this, to);
            if (dropOff == null) {
                Toast.makeText(MovingServiceActivity.this, "Modify the drop off location", Toast.LENGTH_LONG).show();
                return;
            }
    ...
    private void bookOrder() {
        progressDialog = new ProgressDialog(MovingServiceActivity.this);
        ...
        db.collection("orders").add(data).addOnSuccessListener(documentReference -> {
            ...
            Toast.makeText(MovingServiceActivity.this, "Order added successfully!", Toast.LENGTH_SHORT).show();

            Intent i = new Intent(MovingServiceActivity.this, MainActivity.class);
            startActivity(i);
            finish();
        });
    }
    ...
    private void initView() {
        ...
        backBtn = findViewById(R.id.movingBackBtn);
